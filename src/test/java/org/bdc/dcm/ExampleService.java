...
public class ExampleService implements DataTabConf, ServerConf {
    ...
    public void initServerConf() {
        Map<String, Object> serverConfMap = getDataServerConfMap(getClass()
                .getClassLoader().getResourceAsStream(serverConfUri));
        assert (null != serverConfMap);
        serverConf.clear();
        List<Map<String, Object>> serverList = (List<Map<String, Object>>) serverConfMap
                .get("serverConf");
    ...
    public void initDataTabConf() {
        Map<String, Object> dataTabConfMap = getDataTabConfMap(getClass()
                .getClassLoader().getResourceAsStream(dataTabConfUri));

...
public class TcpServer extends NettyBoot {
	
	private static final int SO_BACKLOG = 128;

	private ServerBootstrap serverBootstrap;

	public TcpServer(Server server) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
		super(server);
		init();
	}
	...
	public void task() throws Exception {
		if (isInvalidHost())
			setChannelFuture(serverBootstrap.bind(
